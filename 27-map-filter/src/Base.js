...
export const Base = () => {
    ...
    /*
        - 모든 배열 뒤에 .map
        - array 자료의 개수만큼 함수 안의 코드를 실행해 줌
        - return 안에 있는 것들을 array로 반환해줌
        ...
        만약 이 수가 제공되지 않으면 undefined가 기본값으로 설정됨
    */
...
/*
    ...
    * 공통점 *
    ...
    "forEach"
    - 배열의 각 요소에 대한 주어진 함수를 실행하는 것이 목적
    - 반환값이 없는 함수
    - 배열을 순회하면서 각 요소에 대한 이벥트를 발생시키는데 사용
