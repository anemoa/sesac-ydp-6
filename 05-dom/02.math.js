...
// Q1) 에포크? - 특정 시간의 기준점
// Q2) why? 이 시간 이후인가요?
// A) 1. 역사적인 이후 유닉스 os에서 타임스탬프를 측정하는데 사용된 날짜 초기 컴퓨터 시간 나타냄
...
// getDay(): 주의 몇 번째 날인지 반환한다 (0부터 시작)
// getMonth(): 몇 번째 달인지 반환한다 (0부터 시작)
// getHours(): 시간을 반환한다 (0 ~ 23 까지)
// getMinutes(): 분을 반환한다 (0 ~ 59 까지)
// getMilliseconds(): 밀리초를 반환한다 (0 ~ 999 까지)
// getTime(): 1970년 1월 1일부터 현재까지의 밀리초 단위의 시간을 반환한다
...
console.log(now.getMilliseconds()); // 692
console.log(now.getDay()); // 1 0(일요일) ~ 6(토요일)
...
// 메소드
console.log(Math.min(100, -2, 0, 5)); // -5
